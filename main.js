// ADD ANIMATION TO OUR CURSOR

function cursor(){
    let cursor = document.querySelector('.cursor');
    let body = document.querySelector('body');

    // ADDING EVENT LISTNER TO MOUSE
...
function section2() {
    ...
    // EXCUTE THIS CODE WHENEVER OUR MOUSE ENTER IN OUR SECTION2
    ...
    // EXCUTE THIS CODE WHENEVER OUR MOUSE LEAVE IN OUR SECTION2
